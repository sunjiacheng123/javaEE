...
public class ArticleDAO {
    ...
    public static List<Article> list() {
        ...
        try {
            ...
            //p如果是preparedStament，需要使用无惨的这个方法
            r=p.executeQuery();
            while (r.next()){
            ...
            throw new SystemEexception("000","JDBC操作sql出错",e);
        }finally {
            DBUtil.close(c,p,r);
        }
    }
    ...
    insert into article select id ，？，？，？ from user where name=？
    ...
    public static int insert(Article article) {
        ...
        try {
            ...
            throw new SystemEexception("000","新增文章出错",e);
        }
    }
    ...
    public static Article query(Integer articleId) {
        ...
        try {
            ...
            throw new SystemEexception("003","查询文章详情出错",e);
        }finally {
            DBUtil.close(c,ps,r);
        }
    ...
    public static int update(Article article) {
        ...
        try {
            ...
            throw new SystemEexception("004","修改文章出错",e);
        }finally {
            DBUtil.close(c,ps);
        }
    }
    ...
    public static int delete(int[] ids) {
        ...
        try {
            ...
            throw new SystemEexception("005","删除文章出错",e);
        }finally {
            DBUtil.close(c,p);
        }

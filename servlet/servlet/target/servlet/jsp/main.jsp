...
<body>
    <!--假如，提交到后台的url是http://localhost：8080/servlet/login -->
    <!-- action="login" 现在访问的是http://localhost:8080/servlet/jsp/main.jsp，是以当前页面作为相对路径，加上login-->
    <!-- action="/login" 现在访问的是http://localhost:8080/login-->
    <!-- 添加jsp变量及base标签，可以解决路径问题，action为login，访问时正确路径-->
    <form action="login">
